...
export default function BiologyAssignmentsScience12() {
  ...
  const lessons = [
    {
      ...
      description: 'Biology Lesson 1 materials will be available soon. This will include cell biology, genetics, and related concepts.',
      isComingSoon: true,
    ...
    },
    {
      ...
      description: 'Biology Lesson 2 materials will be available soon. This will include evolution, ecology, and biodiversity concepts.',
      isComingSoon: true,
  ...
  return (
    <div style={{ padding: '1rem', minHeight: '80vh' }}>
      ...
      <h1 className="notes-title text-center mb-6">Science 12 - Biology Assignments</h1>
        ...
        <div className="mb-6 text-center">
          <div className="bg-gray-800 p-4 rounded-lg border border-gray-700">
            ...
            <p className="text-gray-300 text-sm">
              Access your Biology lesson materials here. Click on any lesson to view all pages. 

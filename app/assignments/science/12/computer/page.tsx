...
export default function ComputerAssignmentsScience12() {
  ...
  const lessons = [
    {
      ...
      description: 'Computer Science Lesson 1 materials will be available soon. This will include programming fundamentals, algorithms, and data structures.',
      isComingSoon: true,
    ...
    },
    {
      ...
      description: 'Computer Science Lesson 2 materials will be available soon. This will include database systems, networking, and software engineering concepts.',
      isComingSoon: true,
  ...
  return (
    <div style={{ padding: '1rem', minHeight: '80vh' }}>
      ...
      <h1 className="notes-title text-center mb-6">Science 12 - Computer Science Assignments</h1>
        ...
        <div className="mb-6 text-center">
          <div className="bg-gray-800 p-4 rounded-lg border border-gray-700">
            ...
            <p className="text-gray-300 text-sm">
              Access your Computer Science lesson materials here. Click on any lesson to view all pages. 

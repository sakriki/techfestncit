...
export default function ChemistryAssignmentsScience12() {
  ...
  const lessons = [
    {
      ...
      description: 'Chemistry Lesson 1 materials will be available soon. This will include chemical bonding, molecular structures, and related concepts.',
      isComingSoon: true,
    ...
    },
    {
      ...
      description: 'Chemistry Lesson 2 materials will be available soon. This will include reaction mechanisms, kinetics, and equilibrium concepts.',
      isComingSoon: true,
  ...
  return (
    <div style={{ padding: '1rem', minHeight: '80vh' }}>
      ...
      <h1 className="notes-title text-center mb-6">Science 12 - Chemistry Assignments</h1>
        ...
        <div className="mb-6 text-center">
          <div className="bg-gray-800 p-4 rounded-lg border border-gray-700">
            ...
            <p className="text-gray-300 text-sm">
              Access your Chemistry lesson materials here. Click on any lesson to view all pages. 

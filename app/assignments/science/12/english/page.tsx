...
export default function EnglishAssignmentsScience12() {
  ...
  const lessons = [
    {
      ...
      description: 'English Lesson 1 materials will be available soon. This will include literature analysis, grammar, and writing skills.',
      isComingSoon: true,
    ...
    },
    {
      ...
      description: 'English Lesson 2 materials will be available soon. This will include advanced composition, critical thinking, and communication skills.',
      isComingSoon: true,
  ...
  return (
    <div style={{ padding: '1rem', minHeight: '80vh' }}>
      ...
      <h1 className="notes-title text-center mb-6">Science 12 - English Assignments</h1>
        ...
        <div className="mb-6 text-center">
          <div className="bg-gray-800 p-4 rounded-lg border border-gray-700">
            ...
            <p className="text-gray-300 text-sm">
              Access your English lesson materials here. Click on any lesson to view all pages. 

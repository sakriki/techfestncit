...
export default function ScienceAssignmentsStream() {
    ...
    <div style={{ position: 'relative', minHeight: '100vh', width: '100vw', overflow: 'hidden' }}>
      ...
      <div className="notes-choose-container" style={{
        ...
        <div className="notes-card-row" style={{ justifyContent: 'center' }}>
          <Link href="/assignments/science/11" className="notes-card-link">
            <div className="notes-card science">
              <span className="notes-card-title">Class 11</span>
              <span className="notes-card-desc">Assignments for Science Class 11</span>
            </div>
          </Link>
          <Link href="/assignments/science/12" className="notes-card-link">
            <div className="notes-card science">
              <span className="notes-card-title">Class 12</span>
              <span className="notes-card-desc">Assignments for Science Class 12</span>
            </div>
          </Link>
        </div>
      </div>
